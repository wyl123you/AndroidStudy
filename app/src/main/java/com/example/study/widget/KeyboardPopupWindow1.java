...
/**
 * @Author: Wu Youliang
 * @CreateDate: 2021/5/31 下午3:06
 * @Company LotoGram
 */


public class KeyboardPopupWindow1 extends PopupWindow {
     ...
     */
    public KeyboardPopupWindow1(Context context, View anchorView, EditText editText, boolean isRandomSort) {
    ...
    private void initKeyboardView(View view) {
        ...
        //②给小数点按键设置点击监听
        view.findViewById(R.id.buttonDot).setOnClickListener(v -> {
            int curSelection = editText.getSelectionStart();
            int length = editText.getText().toString().length();
            if (curSelection < length) {
                String content = editText.getText().toString();
